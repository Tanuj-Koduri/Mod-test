...
namespace PimsApp
{
    public partial class Home : Page
    {
        ...
        private void SetupDashboard(List<string> roles)
        {
        ...
        // Rest of the code remains largely the same, with minor improvements in syntax and security
