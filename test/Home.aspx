...
<head runat="server">
    ...
    <link rel="stylesheet" href="~/css/styles.css"> <!-- Moved styles to external CSS file -->
</head>
<body>
            ...
            <div class="row mb-4">
                ...
                <div class="col-12">
                    <asp:GridView ID="gvComplaints" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" 
                        ...
                        <Columns>
                            <!-- GridView columns remain mostly the same, with some CSS class updates -->
                            <asp:BoundField DataField="ComplaintId" HeaderText="Complaint Id" />
                            <asp:BoundField DataField="Name" HeaderText="Name" />
                            <asp:BoundField DataField="EmpId" HeaderText="Emp Id" HeaderStyle-CssClass="text-nowrap" ItemStyle-CssClass="text-nowrap" />
                            ...
                            <asp:TemplateField HeaderText="Action Taken">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnUpdateStatus" runat="server" Text="Update" CssClass="btn btn-primary me-2" CommandName="UpdateStatus" CommandArgument="<%# Container.DataItemIndex %>" />
