...
<body>
    <form id="loginForm" runat="server"> <!-- Updated form ID for clarity -->
        <div class="container">
            <header class="menu-bar"> <!-- Semantic HTML: changed div to header -->
                <h1>Welcome to EcoSight: Ecological Incident Reporting & Monitoring</h1> <!-- Changed label to h1 for better semantics -->
            </header>

            <main class="content"> <!-- Semantic HTML: changed div to main -->
    ...
    <!-- Added JavaScript files at the end of the body for better page load performance -->
